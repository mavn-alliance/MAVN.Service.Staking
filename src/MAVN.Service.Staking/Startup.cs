...
using AutoMapper;
using System;
using MAVN.Service.Staking.MappingProfiles;
using Microsoft.AspNetCore.Mvc;

namespace MAVN.Service.Staking
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "StakingLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.StakingService.Db.LogsConnString;
